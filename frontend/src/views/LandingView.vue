    ...
    <section class="relative overflow-hidden bg-gradient-to-b from-[#050505] to-[#1a1a3e] text-white px-4 md:px-6 py-12 md:py-32">
      ...
      <div class="relative max-w-4xl mx-auto text-center">
        ...
        <div v-else-if="error" class="max-w-md mx-auto text-center py-8">
          ...
          <h3 class="text-base font-semibold text-white mb-1">{{ t('landing.failedToLoad') }}</h3>
        ...
        <div v-else-if="scenarios.length === 0" class="max-w-md mx-auto text-center py-8">
          ...
          <h3 class="text-base font-semibold text-white mb-1">{{ t('landing.noScenarios') }}</h3>
          <p class="text-sm text-white/50">{{ t('landing.noScenariosHint') }}</p>
        </div>
        ...
        >
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div>
                <h3 class="text-sm font-semibold text-white/80 group-hover:text-white transition-colors">{{ t('landing.customSimulation') }}</h3>
                <p class="text-xs text-white/40 mt-1">{{ t('landing.customSimulationDesc') }}</p>
              </div>
            </div>
          </button>
        </TransitionGroup>
