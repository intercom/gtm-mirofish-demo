...
onMounted(() => {
  ...
  if (isDemoMode) {
    messages.value.push({
      role: 'assistant',
      content: "Welcome! I'm the MiroFish Report Agent. I have access to your simulation data and can help you analyze the results.\n\nTry asking me about:\n- **Simulation findings** and key metrics\n- **Which messaging resonated** with different personas\n- **Persona engagement** comparison\n- **Industry vertical** analysis\n- **Recommended next steps**",
      toolCalls: [],
      sources: [],
    })
  }
