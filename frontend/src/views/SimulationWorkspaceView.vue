...
const validTabs = ['graph', 'simulation', 'coalitions']
const initialTab = validTabs.includes(route.query.tab) ? route.query.tab : 'graph'
...
function handleKeydown(e) {
  ...
  else if (e.key === '3') activeTab.value = 'coalitions'
}
