...
import { select, scaleLinear, scaleBand, easeCubicOut, pie, arc, interpolate } from 'd3'
...
function renderBehavioralClusters() {
  ...
  paths.transition()
    ...
    .attrTween('d', function (d) {
      const interpolate = interpolate({ startAngle: d.startAngle, endAngle: d.startAngle }, d)
