<script setup>
// Login view — only rendered when AUTH_ENABLED=true
</script>

<template>
  <div class="min-h-[calc(100vh-120px)] bg-[#050505] flex items-center justify-center px-6">
    <div class="bg-white rounded-xl p-8 w-full max-w-sm text-center">
      ...
      <h2 class="text-lg font-semibold text-[#050505] mb-1">Sign in to MiroFish Demo</h2>
      <p class="text-xs text-[#888] mb-6">Restricted to @intercom.io accounts</p>

      <!-- OAuth Buttons -->
      <div class="space-y-3">
        <button class="w-full flex items-center justify-center gap-2 bg-white border border-black/10 rounded-lg px-4 py-3 text-sm font-medium hover:bg-black/5 transition-colors">
        ...
        <button class="w-full flex items-center justify-center gap-2 bg-[#050505] text-white rounded-lg px-4 py-3 text-sm font-medium hover:bg-[#1a1a3e] transition-colors">
