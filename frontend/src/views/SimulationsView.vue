...
<template>
  ...
  >
    ...
    >
      ...
      <!-- Search / Filter / Sort -->
      <div v-if="store.hasRuns" class="flex flex-col sm:flex-row gap-2 md:gap-3 mb-4 md:mb-6">
      ...
      <div v-else-if="filteredRuns.length === 0" class="text-center py-10 md:py-12">
      ...
      <!-- Activity feed — card-based run list -->
      <div v-else>
