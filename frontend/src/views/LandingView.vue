  ...
  <div>
    ...
    <section class="bg-gradient-to-b from-[#050505] to-[#1a1a3e] text-white px-4 md:px-6 py-12 md:py-32">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <!-- Scenario Cards -->
        <div class="grid grid-cols-1 gap-3 md:gap-4 max-w-2xl mx-auto md:grid-cols-2">
          <button
    ...
    <!-- How It Works -->
    <section class="px-4 md:px-6 py-10 md:py-16 bg-[#fafafa]">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="text-xl md:text-2xl font-semibold text-[#050505] mb-6 md:mb-8">How It Works</h2>
