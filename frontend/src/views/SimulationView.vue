  ...
  <div class="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8">
      <div class="bg-white border border-black/10 rounded-lg p-3 md:p-4 text-center">
        <div class="text-2xl md:text-3xl font-semibold text-[#2068FF]" data-testid="metric-actions">{{ displayActions }}</div>
        <div class="text-xs text-[#888] mt-1">Total Actions</div>
      </div>
      <div class="bg-white border border-black/10 rounded-lg p-3 md:p-4 text-center">
        <div class="text-2xl md:text-3xl font-semibold text-[#ff5600]" data-testid="metric-replies">{{ displayReplies }}</div>
        <div class="text-xs text-[#888] mt-1">Reddit Actions</div>
      </div>
      <div class="bg-white border border-black/10 rounded-lg p-3 md:p-4 text-center">
        <div class="text-2xl md:text-3xl font-semibold text-[#A0F]" data-testid="metric-likes">{{ displayLikes }}</div>
        <div class="text-xs text-[#888] mt-1">Twitter Actions</div>
      </div>
      <div class="bg-white border border-black/10 rounded-lg p-3 md:p-4 text-center">
        <div class="text-2xl md:text-3xl font-semibold text-[#090]" data-testid="metric-round">{{ displayCurrentRound }}/{{ displayTotalRounds }}</div>
